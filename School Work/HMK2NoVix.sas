...
run;
proc sgplot data=work.masterfdic;
series x=date y=ur / markers markerattrs=(color=red symbol='circle') lineattrs=(color=red) legendlabel="ur" ;
series x=date y=cpi / markers markerattrs=(color=blue symbol='circle') lineattrs=(color=blue) legendlabel="cpi" ;
yaxis label='Unemployment and Inflation';

run;
proc sgplot data=work.masterfdic;
series x=date y=cpi / markers markerattrs=(color=green symbol='plus') lineattrs=(color=green) legendlabel="dow" ;
yaxis label='Dow Over Time';

run;
proc sgplot data=work.masterfdic;
series x=date y=vix / markers markerattrs=(color=red symbol='plus') lineattrs=(color=red) legendlabel="vix" ;
yaxis label='Vix Over Time';

run;
proc sgplot data=work.masterfdic;
series x=date y=treas_3m/ markers markerattrs=(color=blue symbol='circle') lineattrs=(color=blue) legendlabel="treas_3m" ;
series x=date y=treas_5y/ markers markerattrs=(color=green symbol='circle') lineattrs=(color=orange) legendlabel="treas_5y" ;
series x=date y=cpi / markers markerattrs=(color=red symbol='circle') lineattrs=(color=red) legendlabel="cpi" ;
...
series x=date y=treas_5y/ markers markerattrs=(color=black symbol='circle') lineattrs=(color=black) legendlabel="treas_5y" ;
...
proc reg data=work.masterfdic plots=(criteria sbc);*all lagged variables.;*eliminating vix bc of missing variables in dataset;
model ideposits =  quarter1 quarter2 quarter3 year
			   ...
			   mort_rate_a1 mort_rate_a2 mort_rate_a3 mort_rate_a4
...
model ideposits_d1  =  quarter1 quarter2 quarter3 year
			   ...
			   mort_rate_d1 mort_rate_d1a1 mort_rate_d1a2 mort_rate_d1a3 mort_rate_d1a4
			   ...
			   treas_10y_d1 treas_10y_d1a1 treas_10y_d1a2 treas_10y_d1a3 treas_10y_d1a4
...
model ideposits_p1 =  quarter1 quarter2 quarter3 year
			   ...
			   mort_rate_p1 mort_rate_p1a1 mort_rate_p1a2 mort_rate_p1a3 mort_rate_p1a4
			   ...
			   treas_10y_p1 treas_10y_p1a1 treas_10y_p1a2 treas_10y_p1a3 treas_10y_p1a4
...
/vif selection=forward slentry=.1 details=steps include=3;
run; quit;
proc reg data=work.masterfdic plots=(criteria sbc);*all lagged variables.;*eliminating vix bc of missing variables in dataset. Also going with stricter SBC;
...
model ideposits_d1 = quarter1 quarter2 quarter3 year cpi_d1 cpi_d1a1 cpi_d1a3 cpi_d1a4 bbb_d1a2 hpi_d1a2 hpi_d1a3 hpi_d1a4 rdi_d1a2/vif;
run; quit;

*Base Predictions;
proc autoreg data=work.masterfdic;
title 'Base Predictions';
where scenario in ('actuals','fbase');
model ideposits_d1 = quarter1 quarter2 quarter3 year cpi_d1 cpi_d1a1 cpi_d1a3 cpi_d1a4 bbb_d1a2 hpi_d1a2 hpi_d1a3 hpi_d1a4 rdi_d1a2
...
*Adverse Predictions;
proc autoreg data=work.masterfdic;
title 'Adverse Predictions';
where scenario in ('actuals','fadvr');
model ideposits_d1 = quarter1 quarter2 quarter3 year cpi_d1 cpi_d1a1 cpi_d1a3 cpi_d1a4 bbb_d1a2 hpi_d1a2 hpi_d1a3 hpi_d1a4 rdi_d1a2
/covest=neweywest dw=4 dwprob godfrey=4 normal archtest=(qlm,lk) method=ml; *Q,LM and Lee and King (lk) tests of arch errors;
output out=pred_fadvr (keep=year date scenario ideposits ideposits_d1 rdi ur cpi treas_5y pred_ideposits_d1 r_ideposits_d1) p=pred_ideposits_d1 r=r_ideposits_d1;
run;
*Severe Predictions;
proc autoreg data=work.masterfdic;
title 'Severe Predictions';
where scenario in ('actuals','fsevr');
model ideposits_d1 = quarter1 quarter2 quarter3 year cpi_d1 cpi_d1a1 cpi_d1a3 cpi_d1a4 bbb_d1a2 hpi_d1a2 hpi_d1a3 hpi_d1a4 rdi_d1a2
/covest=neweywest dw=4 dwprob godfrey=4 normal archtest=(qlm,lk) method=ml; *Q,LM and Lee and King (lk) tests of arch errors;
output out=pred_fsevr (keep=year date scenario ideposits ideposits_d1 rdi ur cpi treas_5y pred_ideposits_d1 r_ideposits_d1) p=pred_ideposits_d1 r=r_ideposits_d1;
run;

data work.masterforecast;
merge work.pred_fbase
      work.pred_fadvr
	  work.pred_fsevr;
by scenario;
run;
...
PROC EXPORT DATA= work.pred_fbase
            OUTFILE= "C:\Users\king.2615\Downloads\Stress Test I_Deposits.xlsx" 
            DBMS=XLSX replace;
     SHEET="Base"; 
RUN;
/**********Exporting and storing predicted values *******/
PROC EXPORT DATA= work.pred_fadvr
            OUTFILE= "C:\Users\king.2615\Downloads\Stress Test I_Deposits.xlsx" 
            DBMS=XLSX replace;
     SHEET="Adverse"; 
RUN;
/**********Exporting and storing predicted values *******/
PROC EXPORT DATA= work.pred_fsevr
            OUTFILE= "C:\Users\king.2615\Downloads\Stress Test I_Deposits.xlsx" 
            DBMS=XLSX replace;
     SHEET="Severe"; 
RUN;
/**********Exporting and storing predicted values *******/
PROC EXPORT DATA= work.masterforecast
            OUTFILE= "C:\Users\king.2615\Downloads\Stress Test I_Deposits.xlsx" 
            DBMS=XLSX replace;
     SHEET="Forecast"; 
RUN;
